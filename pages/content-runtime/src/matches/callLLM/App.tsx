...
//   useEffect(() => {
//     //this only gets called once on mount, maybe it should be called everytime the user presses the key
...
//   return <div className="ceb-fourth-runtime-content-view-text">{displayContent}</div>;
// }
